export const workoutProgram = {
    0: {  // Ruck
        ...
        workout: [
            { name: "Pack floor press", sets: 4, reps: 15 },
            { name: "Incline pushups on pack", sets: 3, reps: 20 },
            { name: "Alternating pack flies (floor)", sets: 3, reps: 15 },
            { name: "Overhead pack hold", sets: 3, reps: 45 },
            { name: "Pack triceps extension", sets: 3, reps: 20 }
        ]
    },
    1: {  // FS
        warmup: [
            { name: "Wall rows", sets: 2, reps: 20 },
            { name: "Scapular prone pulls", sets: 2, reps: 15 }
        ],
        workout: [
            { name: "Pack bent-over rows", sets: 4, reps: 12 },
            { name: "Inverted body rows (table)", sets: 3, reps: 15 },
            { name: "Single-arm pack rows", sets: 3, reps: 12 },
            { name: "Pack curls", sets: 3, reps: 15 },
            { name: "Pack static holds", sets: 3, reps: 30 }
        ]
    },
    2: {  // FB
        warmup: [
        ...
        workout: [
            { name: "Front-loaded pack squats", sets: 4, reps: 15 },
            { name: "Walking lunges with pack", sets: 3, reps: 20 },
            { name: "Hip thrusts with pack", sets: 3, reps: 15 },
            { name: "Pack Romanian deadlifts", sets: 3, reps: 12 },
            { name: "Calf raises with pack", sets: 3, reps: 25 }
        ]
    },
    3: {  // Ruck
        warmup: [
            { name: "Pack shoulder rotations", sets: 2, reps: 25 },
            { name: "Scapular pushups with pack", sets: 2, reps: 20 }
        ],
        workout: [
            { name: "Weighted pushups (pack on back)", sets: 4, reps: 20 },
            { name: "Pack presses (floor)", sets: 3, reps: 15 },
            { name: "Pushup to shoulder tap", sets: 3, reps: 20 },
            { name: "Overhead carry march", sets: 3, reps: 60 },
    ...
    4: {  // FS
        ...
        workout: [
            ...
            { name: "Bodyweight reverse snow angels", sets: 3, reps: 15 },
    ...
    5: {  // FB
        warmup: [
            { name: "Bridge march", sets: 2, reps: 25 },
            { name: "Squat mobility drills", sets: 2, reps: 15 }
        ],
        workout: [
            { name: "Pack deadlifts", sets: 3, reps: 15 },
            { name: "Pack step-ups", sets: 3, reps: 20 },
            { name: "Pack good mornings", sets: 3, reps: 12 },
            { name: "Hip thrusts with pack", sets: 3, reps: 15 },
    ...
    6: {  // Ruck
        warmup: [
            { name: "Shoulder rolls with pack", sets: 2, reps: 25 },
            { name: "Scapular pushups", sets: 2, reps: 20 }
        ],
        workout: [
            { name: "Pack bench press (floor)", sets: 3, reps: 15 },
            { name: "Incline pushups", sets: 3, reps: 20 },
            { name: "Pack shoulder press", sets: 3, reps: 12 },
            { name: "Pack overhead hold march", sets: 3, reps: 40 },
            { name: "Triceps extensions with pack", sets: 3, reps: 15 }
        ]
    },
    7: {  // FS
        warmup: [
            { name: "Wall body rows", sets: 2, reps: 20 },
            { name: "Pack arm circles", sets: 2, reps: 25 }
        ],
        workout: [
            { name: "Pack rows", sets: 3, reps: 12 },
            { name: "Pack one-arm rows", sets: 3, reps: 10 },
            { name: "Pack rear delt raises", sets: 3, reps: 15 },
            { name: "Pack biceps curls", sets: 3, reps: 15 },
            { name: "Pack static shrugs", sets: 3, reps: 30 }
        ]
    },
    8: {  // FB
        warmup: [
            { name: "Bridge holds", sets: 2, reps: 25 },
            { name: "Squat to hinge drill", sets: 2, reps: 15 }
        ],
        workout: [
            { name: "Pack squats", sets: 4, reps: 15 },
            { name: "Split squats with pack", sets: 3, reps: 12 },
            { name: "Pack RDLs", sets: 3, reps: 12 },
            { name: "Pack hip thrusts", sets: 3, reps: 15 },
            { name: "Pack calf raises", sets: 3, reps: 25 }
        ]
    },
    9: {  // Ruck
        warmup: [
            { name: "Ruck shoulder rotations", sets: 2, reps: 20 },
            { name: "Pack pushup scap drills", sets: 2, reps: 20 }
        ],
        workout: [
            { name: "Pack pushups (weighted)", sets: 3, reps: 20 },
            { name: "Pack chest press (floor)", sets: 3, reps: 15 },
            { name: "Alternating pack flies", sets: 3, reps: 15 },
            { name: "Pack triceps dips", sets: 3, reps: 15 },
            { name: "Overhead ruck march", sets: 3, reps: 60 }
        ]
    },
    10: {  // FS
        warmup: [
